...
public class DataPolizy {
    ...
    public DataPolizy(Long id_policy_data, int amount_data, String employee_first_name_data, String employee_last_name_data, String sku_data, String item_name_data, String status_policy_data, LocalDate policy_date_data) {
